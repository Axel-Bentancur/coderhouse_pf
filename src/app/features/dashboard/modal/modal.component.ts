...
export class  ModalComponent {
  element: IStudent | ICourse | ICourse | null = null;
  displayName: string = '';
  ...
  constructor(
    ...
    @Inject(MAT_DIALOG_DATA) public data: { action: 'Delete' | 'Edit' | 'Create' | 'Add'; entity: 'Course' | 'Student'; element: IStudent | ICourse | null }
  ) {
